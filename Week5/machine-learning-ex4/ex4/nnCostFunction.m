...
%--------------------------------------------Part 1--------------------------------------------%
% Forward pass
% Adding a column of ones at the start of the Features Matrix
a1 = [ones(m, 1) X]; % 5000 * 401
z1 = a1 * Theta1'; % (5000*401, 401*25)
a2 = sigmoid(z1);  % 5000*25
a2 = [ones(m, 1) a2]; % 5000*26
z3 = a2 * Theta2'; % (5000*26, 26*10)
h = sigmoid(z3); % 5000*10

y_new = zeros(m, num_labels); % Prefill matrix of zeros for classification, size (m, num_labels)
...
for t = 1:m
    ...
    a3 = sigmoid(z3); % h , 10*1

    % step 2
    delta_3 = a3' - y_new(t, :); % (1*10)
    z2=[1; z2]; % bias (26*1)
    % Step 3
    delta_2 = (Theta2' * delta_3') .* sigmoidGradient(z2); % (1*10 * 10*26)
    % Step 4
